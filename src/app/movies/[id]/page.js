            ...
            {isLoading ? <SpinnerSvg /> :
                <div className="flex w-5xl">
                    ...
                    <div className="flex flex-col justify-between items-center w-[612]">    
                        ...
                        <div>
                            <button onClick={() => router.push(`/watch/${id}`)} className="w-40 h-15 bg-mint-100 text-teal-700 font-bold text-2xl rounded-4xl cursor-pointer hover:bg-mint-200 transition-all active:bg-teal-500">Watch</button>
                        </div>
                    </div>
                </div>}
        </div>
